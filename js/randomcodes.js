...
function generateCode() {
    //Create variables to store generated code and the type of characters we want to show as codes
    var code = ' '; //to store generated codes and intialize to empty value
    ...
    return code; //return the final accumulate string when loop ends
}
...
codebox.addEventListener("input", evaluateCode); //listen to code entered in textbox
 ...
 function evaluateCode() {
    ...
    var charset2 = code.trim(); // remove any hidden characters generated
     //test if code entered matches the numner of generated characters
     if (charset1.length == charset2.length && charset2 == charset2) {
